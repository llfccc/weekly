...
export default {
    ...
    methods: {
        ...
        timeChange(val) {
            ...
            v.form.start_time = convertTime(val[0])
            v.form.end_time = convertTime(val[1])
        },
        ...
        addWork: function () {
            ...
            let str = 'event_date=' + v.form.event_date + '&start_time=' + v.form.start_time + '&end_time=' + v.form.end_time + '&description=' + v.form.description + '&fin_percentage=' + v.form.fin_percentage + '&up_reporter_id=' + v.form.up_reporter_id + '&down_reporter_ids=' + v.form.down_reporter_ids + '&dev_event_remark=' + v.form.dev_event_remark + '&dev_event_project_id=' + v.form.dev_event_project_id + '&dev_event_type_id=' + v.form.dev_event_type_id;
