...
urlpatterns = [
    ...
    url(r'del_devevent/', permission_required('api.markDel_devevent')(DelDevEvent.as_view()), name="api_DelWork"),
    ...
    url(r'insert_customer/', permission_required('api.insert_salecustomer')(InsertCustomer.as_view()), name="api_DelWork"),
    url(r'del_sale_event/', permission_required('api.markDel__saleevent')(DelSaleEvent.as_view()), name="api_DelSaleEvent"),  
